<template>
  <div id="app">
    <div class="container">
      ...
      <p align="center">
        <img
          :src="`https://img.shields.io/badge/DEMO-v${version}-41b883.svg?style=flat-square`"
        />
        <a href="https://www.npmjs.com/package/vue-aplayer"
          ><img
            src="https://img.shields.io/npm/v/vue-aplayer.svg?style=flat-square"
        /></a>
        <a href="https://www.npmjs.com/package/vue-aplayer"
          ><img
            src="https://img.shields.io/npm/dt/vue-aplayer.svg?style=flat-square"
        /></a>
      </p>
      <p>
        <a href="https://github.com/SevenOutman/vue-aplayer/commits/develop">
          <img
            src="https://img.shields.io/github/commit-activity/y/SevenOutman/vue-aplayer.svg?style=flat-square"
          />
        </a>
        <a href="https://github.com/SevenOutman/vue-aplayer/commits/develop">
          <img
            src="https://img.shields.io/github/last-commit/SevenOutman/vue-aplayer/develop.svg?style=flat-square"
          />
        </a>
        <a href="https://github.com/SevenOutman/vue-aplayer/blob/master/LICENSE"
          ><img
            src="https://img.shields.io/npm/l/vue-aplayer.svg?style=flat-square"
        /></a>
      </p>
      ...
      <footer align="center">
        <p>
          Thank
          <a href="https://github.com/DIYgod" target="_blank">@DIYgod</a> and
          <a href="https://github.com/MoePlayer/APlayer" target="_blank"
            >APlayer</a
          >
          for hosting demo resources
        </p>
      </footer>
    </div>
  </div>
...
body {
  font-family: Source Sans Pro, "PingFang SC", "Helvetica Neue", Helvetica,
    Arial, sans-serif;
